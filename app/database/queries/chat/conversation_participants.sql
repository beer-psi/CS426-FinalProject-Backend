...
SELECT
    p.conversation_id AS participant_conversation_id,
...
-- name: get_conversation_participants_by_user(user_id)
-- Get all conversation participant objects for this user.
SELECT
    p.conversation_id AS participant_conversation_id,
    p.role AS participant_role,
    p.read_at AS participant_read_at,
